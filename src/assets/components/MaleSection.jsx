...
const slides = [
  ...
  },
  {
    ...
    badge: "New",
    category: "Fashionista's Pick",
    title: "Sleek silhouettes for every occasion",
    desc: "From brunch to the block — our men's collection blends elegance with edge in every step.",
    priceFrom: "$55.00",
    priceTo: "$195.00",
  },
  {
...
export default function MaleSection({ isDark }) {
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-10 sm:mb-14">
            ...
            <div>
              ...
              <h2 className={`text-3xl sm:text-5xl lg:text-6xl font-black leading-[1.05] tracking-tight ${
                ...
                Modern collections
                <br />
                <span className="text-red-500">defined by</span> simplicity
              </h2>
            </div>

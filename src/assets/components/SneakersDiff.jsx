...
const products = [
  ...
  },
  {
    ...
    hoverSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/category-page-04-image-card-03.jpg',
  ...
  },
  {
    ...
    hoverSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/category-page-04-image-card-04.jpg',
  ...
  },
  {
    ...
    hoverSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/category-page-04-image-card-05.jpg',
  ...
  },
  {
    ...
    hoverSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/category-page-04-image-card-06.jpg',
  ...
  },
  {
    ...
    hoverSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/category-page-04-image-card-07.jpg',
  ...
  },
  {
    ...
    hoverSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/category-page-04-image-card-08.jpg',
  ...
  },
  {
    ...
    hoverSrc: 'https://tailwindcss.com/plus-assets/img/ecommerce-images/category-page-04-image-card-01.jpg',
    imageAlt: 'Sneaker lifestyle view',
  },
];

export default function ProductGrid({ isDark }) {
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-14">
          <div>
            ...
            <h2 className={`text-5xl sm:text-6xl font-black leading-[1.05] tracking-tight ${
              ...
              Fresh fits in<br />
              <span className="text-red-500">our latest</span> drop
            </h2>
          </div>
